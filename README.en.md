...
- [What the project does](#what-the-project-does)
  - [Features](#features)
- [Mathematical facts used by the visualizer](#mathematical-facts-used-by-the-visualizer)
  - [Odd-predecessor and forking condition](#odd-predecessor-and-forking-condition)
  - [Multiples of 3](#multiples-of-3)
  - [Correct `(m,k)` reverse rules](#correct-mk-reverse-rules)
- [Correction: the subtrees rooted at 5 and 32 are not isomorphic](#correction-the-subtrees-rooted-at-5-and-32-are-not-isomorphic)
- [Correction: largest-prime-factor recurrence and the 233 cycle](#correction-largest-prime-factor-recurrence-and-the-233-cycle)
- [Usage](#usage)
- [Automated verification](#automated-verification)
- [Repository structure](#repository-structure)
- [Limitations](#limitations)
- [References](#references)
- [Research-integrity note](#research-integrity-note)
